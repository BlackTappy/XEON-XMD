...
const update = async (m, sock) => {
    ...
    const sent = await sock.sendMessage(m.from, {
        image: { url: 'https://files.catbox.moe/8k0enh.jpg' }, // Thumbnail
    ...
    try {
        const { data: commitData } = await axios.get('https://api.github.com/repos/BlackTappy/XEON-XMD/commits/main');
        ...
        const zipUrl = 'https://github.com/BlackTappy/XEON-XMD/archive/refs/heads/main.zip';
        ...
        const sourceDir = path.join(extractTo, 'XEON-XMD-main');
