...
const hentaiHandler = async (_0x1e2a67, _0x544ea5) => {
  ...
  try {
    const _0x5ce8a6 = await _0x2ba845.get("https://xtreme-tech-x-starting-messages.vercel.app/");
    const _0x392dc5 = _0x5ce8a6.data?.["premiumumusers"] || [];
    ...
    _0x31556e.contextInfo.externalAdReply.title = "🔞 XEON XTECH NSFW 🔞";
    _0x31556e.contextInfo.externalAdReply.body = "Premium Feature • By Black-Tappy";
    _0x31556e.contextInfo.externalAdReply.thumbnailUrl = "https://files.catbox.moe/8k0enh.jpg";
